				...
				<form name="frm" action="${root }/memberUpdate" method="post">
					...
					<table class='table table-bordered' style="text-align: center;">
						...
						<tr>
							...
							<td colspan="2"><input class="form-control" type="text" id="memberName" name="memberName" placeholder="이름을 확인" value=${memberVo.member.memberName } /></td>
						</tr>

						<tr>
							<th style="width: 100px; vertical-align: middle;">나이</th>
							<td colspan="2"><input id="memberAge" name="memberAge" class="form-control" type="number" maxlength="10" placeholder="나이를 입력하세요." value=${memberVo.member.memberAge } /></td>
						</tr>
						...
						<tr>
							...
							<td colspan="2">
								<input id="memberEmail" name="memberEmail" class="form-control" type="text" maxlength="20" placeholder="이메일을 입력하세요." value="${memberVo.member.memberEmail }"/>
							</td>
						</tr>
